...
namespace MagicVilla_API.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public async Task<LoginResponseDTO> Login(LoginRequestDTO loginRequestDTO)
        {
            ...
            bool isValido = await _userManager.CheckPasswordAsync(usuario, loginRequestDTO.Password); //Validar el usuario y contraseña sean correctos
        ...
        public async Task<UsuarioDto> Registrar(RegistroRequestDTO registroRequestDTO)
        {
            ...
            try
            {
                ...
                {
                    if(!_roleManager.RoleExistsAsync("admin").GetAwaiter().GetResult()) //Valida que el rol existe creado en la BD
                    {
                        await _roleManager.CreateAsync(new IdentityRole("admin")); //Crea el rol en la BD
